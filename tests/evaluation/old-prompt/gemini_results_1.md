...
| 14 | 14_sales_analysis_widgets_plots.ipynb | FAIL | SKIP | SKIP | YES | AUTO_FAIL | Reason: LLM produced invalid Python in cell 1; output file missing; output file missing; large notebook with widgets, tables, and plots needs manual review |
| 15 | 15_combined_jupyter_features.ipynb | STOPPED_QUOTA | SKIP | SKIP | YES | STOPPED_QUOTA | quota or token limit reached; output file missing; output file missing; large combined Jupyter-feature notebook needs manual review |
